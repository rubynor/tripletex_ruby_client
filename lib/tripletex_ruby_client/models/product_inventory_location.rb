...
module TripletexRubyClient
  class ProductInventoryLocation
    ...
    attr_accessor :is_main_location
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isMainLocation')
        self.is_main_location = attributes[:'isMainLocation']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_main_location == o.is_main_location &&
    ...
    def hash
      [id, version, changes, url, product, inventory, inventory_location, is_main_location, stock_of_goods].hash
    end
