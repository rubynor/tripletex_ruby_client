...
module TripletexRubyClient
  class Activity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'costPercentage')
        self.cost_percentage = attributes[:'costPercentage']
      end
    ...
    def valid?
      ...
      activity_type_validator = EnumAttributeValidator.new('String', ['GENERAL_ACTIVITY', 'PROJECT_GENERAL_ACTIVITY', 'PROJECT_SPECIFIC_ACTIVITY', 'TASK'])
    ...
    def activity_type=(activity_type)
      validator = EnumAttributeValidator.new('String', ['GENERAL_ACTIVITY', 'PROJECT_GENERAL_ACTIVITY', 'PROJECT_SPECIFIC_ACTIVITY', 'TASK'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rate == o.rate &&
          cost_percentage == o.cost_percentage &&
    ...
    def hash
      [id, version, changes, url, name, number, description, activity_type, is_project_activity, is_general, is_task, is_disabled, is_chargeable, rate, cost_percentage, display_name].hash
    end
