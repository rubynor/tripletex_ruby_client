...
module TripletexRubyClient
  class DiscountGroup
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nameAndNumber')
        self.name_and_number = attributes[:'nameAndNumber']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          number == o.number &&
          name_and_number == o.name_and_number
    end
    ...
    def hash
      [id, version, changes, url, name, number, name_and_number].hash
    end
