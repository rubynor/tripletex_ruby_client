...
module TripletexRubyClient
  class ProjectOrderLine
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isBudget')
    ...
    def hash
      [id, version, changes, url, product, inventory, inventory_location, description, count, unit_cost_currency, unit_price_excluding_vat_currency, currency, markup, discount, vat_type, amount_excluding_vat_currency, amount_including_vat_currency, project, date, is_chargeable, is_budget, invoice].hash
    end
