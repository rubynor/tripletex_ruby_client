...
module TripletexRubyClient
  class FormDataBodyPart
    ...
    attr_accessor :form_data_content_disposition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'messageBodyWorkers')
        self.message_body_workers = attributes[:'messageBodyWorkers']
      end
      ...
      if attributes.has_key?(:'simple')
        self.simple = attributes[:'simple']
      end

      if attributes.has_key?(:'formDataContentDisposition')
        self.form_data_content_disposition = attributes[:'formDataContentDisposition']
      end
      ...
      if attributes.has_key?(:'parameterizedHeaders')
        if (value = attributes[:'parameterizedHeaders']).is_a?(Hash)
    ...
    def hash
      [content_disposition, entity, headers, media_type, message_body_workers, parent, providers, simple, form_data_content_disposition, name, value, parameterized_headers].hash
    end
