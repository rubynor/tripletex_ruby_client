...
module TripletexRubyClient
  class ProductGroup
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parentGroup')
        self.parent_group = attributes[:'parentGroup']
      end
    ...
    def hash
      [id, version, changes, url, name, parent_group, is_deletable].hash
    end
