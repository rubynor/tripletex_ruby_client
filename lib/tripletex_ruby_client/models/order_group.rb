...
module TripletexRubyClient
  class OrderGroup
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sortIndex')
        self.sort_index = attributes[:'sortIndex']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@sort_index.nil? && @sort_index < 0
        invalid_properties.push('invalid value for "sort_index", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@sort_index.nil? && @sort_index < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] sort_index Value to be assigned
    def sort_index=(sort_index)
      if !sort_index.nil? && sort_index < 0
        fail ArgumentError, 'invalid value for "sort_index", must be greater than or equal to 0.'
      end
    ...
    def hash
      [id, version, changes, url, order, title, comment, sort_index].hash
    end
