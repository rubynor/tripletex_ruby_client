...
module TripletexRubyClient
  class ProductSettings
    ...
    attr_accessor :product_purchase
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'productPurchase')
        self.product_purchase = attributes[:'productPurchase']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          product_purchase == o.product_purchase &&
    ...
    def hash
      [id, version, changes, url, warehouse, product_purchase, purchase_order].hash
    end
