...
module TripletexRubyClient
  class Currency
    ...
    def list_invalid_properties
      ...
      if !@factor.nil? && @factor > 100
        invalid_properties.push('invalid value for "factor", must be smaller than or equal to 100.')
      end

      if !@factor.nil? && @factor < 1
        invalid_properties.push('invalid value for "factor", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@factor.nil? && @factor > 100
      return false if !@factor.nil? && @factor < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] factor Value to be assigned
    def factor=(factor)
      if !factor.nil? && factor > 100
        fail ArgumentError, 'invalid value for "factor", must be smaller than or equal to 100.'
      end

      if !factor.nil? && factor < 1
        fail ArgumentError, 'invalid value for "factor", must be greater than or equal to 1.'
      end
    ...
    def hash
      [id, version, changes, url, code, description, factor, display_name].hash
    end
