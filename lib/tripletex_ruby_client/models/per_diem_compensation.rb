...
module TripletexRubyClient
  class PerDiemCompensation
    ...
    def hash
      [id, version, changes, url, travel_expense, rate_type, rate_category, country_code, travel_expense_zone_id, overnight_accommodation, location, address, count, rate, amount, is_deduction_for_breakfast, is_deduction_for_lunch, is_deduction_for_dinner].hash
    end
