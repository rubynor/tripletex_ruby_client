...
module TripletexRubyClient
  class ElectronicSupportDTO
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bankUrl')
        self.bank_url = attributes[:'bankUrl']
      end
    end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['PARTIAL', 'COMPLETE', 'PSD2'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['PARTIAL', 'COMPLETE', 'PSD2'])
    ...
    def hash
      [bank_id, bank_name, type, bank_url].hash
    end
