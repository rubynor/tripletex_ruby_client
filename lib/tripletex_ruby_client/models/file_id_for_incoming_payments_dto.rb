...
module TripletexRubyClient
  class FileIdForIncomingPaymentsDTO
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'postingIds')
        if (value = attributes[:'postingIds']).is_a?(Array)
          self.posting_ids = value
        end
      end
    end
    ...
    def hash
      [file_id, date, account_number, posting_ids].hash
    end
