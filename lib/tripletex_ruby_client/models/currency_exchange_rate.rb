...
module TripletexRubyClient
  class CurrencyExchangeRate
    ...
    def valid?
      ...
      return false if !@rate.nil? && @rate < 0
      source_validator = EnumAttributeValidator.new('String', ['NORGES_BANK', 'HALLONEN'])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('String', ['NORGES_BANK', 'HALLONEN'])
    ...
    def hash
      [id, version, changes, url, target_currency, source_currency, rate, source, date].hash
    end
