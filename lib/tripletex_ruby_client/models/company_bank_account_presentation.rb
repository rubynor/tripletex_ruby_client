...
module TripletexRubyClient
  class CompanyBankAccountPresentation
    # Iban-number
    attr_accessor :iban
    ...
    def valid?
      provider_validator = EnumAttributeValidator.new('String', ['NETS', 'AUTOPAY'])
    ...
    def provider=(provider)
      validator = EnumAttributeValidator.new('String', ['NETS', 'AUTOPAY'])
    ...
    def hash
      [iban, bban, bic, country, provider].hash
    end
