...
module TripletexRubyClient
  class FormDataMultiPart
    ...
    def self.swagger_types
      {
        ...
        :'fields' => :'Hash<String, Array<FormDataBodyPart>>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bodyParts')
        if (value = attributes[:'bodyParts']).is_a?(Array)
    ...
    def hash
      [content_disposition, entity, headers, media_type, message_body_workers, parent, providers, body_parts, fields, parameterized_headers].hash
    end
