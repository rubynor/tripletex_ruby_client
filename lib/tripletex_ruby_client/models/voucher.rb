...
module TripletexRubyClient
  class Voucher
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tempNumber')
        self.temp_number = attributes[:'tempNumber']
      end
    ...
    def list_invalid_properties
      ...
      if !@temp_number.nil? && @temp_number < 0
        invalid_properties.push('invalid value for "temp_number", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@temp_number.nil? && @temp_number < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] temp_number Value to be assigned
    def temp_number=(temp_number)
      if !temp_number.nil? && temp_number < 0
        fail ArgumentError, 'invalid value for "temp_number", must be greater than or equal to 0.'
      end
    ...
    def hash
      [id, version, changes, url, date, number, temp_number, year, description, voucher_type, reverse_voucher, postings, document, attachment, external_voucher_number, edi_document].hash
    end
