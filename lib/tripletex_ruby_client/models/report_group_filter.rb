...
module TripletexRubyClient
  class ReportGroupFilter
    ...
    def self.swagger_types
      {
        :'account' => :'ReportFilterAccount',
        :'customer' => :'ReportFilterCustomer',
        :'department' => :'ReportFilterDepartment',
        :'employee' => :'ReportFilterEmployee',
        :'period' => :'ReportFilterPeriod',
        :'product' => :'ReportFilterProduct',
        :'project' => :'ReportFilterProject',
        :'supplier' => :'ReportFilterSupplier',
    ...
    def hash
      [account, customer, department, employee, period, product, project, supplier, general, version].hash
    end
