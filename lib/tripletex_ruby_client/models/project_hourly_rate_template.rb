...
module TripletexRubyClient
  class ProjectHourlyRateTemplate
    ...
    def self.swagger_types
      {
        ...
        :'project_specific_rates' => :'Array<ProjectSpecificRateTemplate>',
        :'fixed_rate' => :'Float'
      }
    end
    ...
    def hash
      [start_date, show_in_project_order, hourly_rate_model, project_specific_rates, fixed_rate].hash
    end
