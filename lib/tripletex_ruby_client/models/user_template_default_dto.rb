...
module TripletexRubyClient
  class UserTemplateDefaultDTO
    ...
    def valid?
      template_validator = EnumAttributeValidator.new('String', ['SIMPLE', 'FANCY', 'PAY_ME_PAYMENT_FOCUS'])
    ...
    def template=(template)
      validator = EnumAttributeValidator.new('String', ['SIMPLE', 'FANCY', 'PAY_ME_PAYMENT_FOCUS'])
    ...
    def hash
      [name, description, template, colors, fields, comments, images].hash
    end
