...
module TripletexRubyClient
  class ProjectPeriodInvoicingReserve
    attr_accessor :invoice_fee_reserve_currency

    attr_accessor :period_order_lines_income_currency
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'periodOrderLinesIncomeCurrency')
        self.period_order_lines_income_currency = attributes[:'periodOrderLinesIncomeCurrency']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          period_order_lines_income_currency == o.period_order_lines_income_currency &&
    ...
    def hash
      [invoice_fee_reserve_currency, period_order_lines_income_currency, invoice_extracosts_reserve_currency, invoice_akonto_reserve_amount_currency, invoice_reserve_total_amount_currency].hash
    end
