...
module TripletexRubyClient
  class VatReturnsComment
    ...
    # Detailed description of the comment
    attr_accessor :vat_specification_type

    # The sign expected on the structured comment
    attr_accessor :expected_sign
    ...
    # @param [Object] vat_specification_type Object to be assigned
    def vat_specification_type=(vat_specification_type)
      validator = EnumAttributeValidator.new('String', ['DEFAULT', 'LOSS_OF_CLAIM', 'WITHDRAWAL', 'ADJUSTMENT', 'REVERSAL'])
      unless validator.valid?(vat_specification_type)
        fail ArgumentError, 'invalid value for "vat_specification_type", must be one of #{validator.allowable_values}.'
      end
      @vat_specification_type = vat_specification_type
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] expected_sign Object to be assigned
    def expected_sign=(expected_sign)
      validator = EnumAttributeValidator.new('String', ['ZERO', 'POSITIVE', 'NEGATIVE'])
      unless validator.valid?(expected_sign)
        fail ArgumentError, 'invalid value for "expected_sign", must be one of #{validator.allowable_values}.'
      end
