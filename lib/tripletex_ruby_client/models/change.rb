...
module TripletexRubyClient
  class Change
    ...
    def valid?
      change_type_validator = EnumAttributeValidator.new('String', ['CREATE', 'UPDATE', 'DELETE', 'LOCKED', 'REOPENED', 'DO_NOT_SHOW'])
    ...
    def change_type=(change_type)
      validator = EnumAttributeValidator.new('String', ['CREATE', 'UPDATE', 'DELETE', 'LOCKED', 'REOPENED', 'DO_NOT_SHOW'])
