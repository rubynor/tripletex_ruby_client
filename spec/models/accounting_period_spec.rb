...
# Unit tests for TripletexRubyClient::AccountingPeriod
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AccountingPeriod' do
  before do
    # run before each test
    @instance = TripletexRubyClient::AccountingPeriod.new
  end
  ...
  describe 'test an instance of AccountingPeriod' do
    it 'should create an instance of AccountingPeriod' do
      expect(@instance).to be_instance_of(TripletexRubyClient::AccountingPeriod)
    end
  end
