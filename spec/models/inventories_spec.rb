...
# Unit tests for TripletexRubyClient::Inventories
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Inventories' do
  before do
    # run before each test
    @instance = TripletexRubyClient::Inventories.new
  end
  ...
  describe 'test an instance of Inventories' do
    it 'should create an instance of Inventories' do
      expect(@instance).to be_instance_of(TripletexRubyClient::Inventories)
    end
  end
