...
# Unit tests for TripletexRubyClient::BankTransaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankTransaction' do
  before do
    # run before each test
    @instance = TripletexRubyClient::BankTransaction.new
  end
  ...
  describe 'test an instance of BankTransaction' do
    it 'should create an instance of BankTransaction' do
      expect(@instance).to be_instance_of(TripletexRubyClient::BankTransaction)
    end
  end
