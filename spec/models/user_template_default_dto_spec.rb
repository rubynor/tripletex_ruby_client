...
# Unit tests for TripletexRubyClient::UserTemplateDefaultDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserTemplateDefaultDTO' do
  before do
    # run before each test
    @instance = TripletexRubyClient::UserTemplateDefaultDTO.new
  end
  ...
  describe 'test an instance of UserTemplateDefaultDTO' do
    it 'should create an instance of UserTemplateDefaultDTO' do
      expect(@instance).to be_instance_of(TripletexRubyClient::UserTemplateDefaultDTO)
    end
  end
