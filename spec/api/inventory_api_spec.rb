...
# Unit tests for TripletexRubyClient::InventoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InventoryApi' do
  before do
    # run before each test
    @instance = TripletexRubyClient::InventoryApi.new
  end
  ...
  describe 'test an instance of InventoryApi' do
    it 'should create an instance of InventoryApi' do
      expect(@instance).to be_instance_of(TripletexRubyClient::InventoryApi)
    end
  end
