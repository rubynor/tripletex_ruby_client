...
# Unit tests for TripletexRubyClient::LedgerpostingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LedgerpostingApi' do
  before do
    # run before each test
    @instance = TripletexRubyClient::LedgerpostingApi.new
  end
  ...
  describe 'test an instance of LedgerpostingApi' do
    it 'should create an instance of LedgerpostingApi' do
      expect(@instance).to be_instance_of(TripletexRubyClient::LedgerpostingApi)
    end
  end
