...
# Unit tests for TripletexRubyClient::TravelExpensecostApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelExpensecostApi' do
  before do
    # run before each test
    @instance = TripletexRubyClient::TravelExpensecostApi.new
  end
  ...
  describe 'test an instance of TravelExpensecostApi' do
    it 'should create an instance of TravelExpensecostApi' do
      expect(@instance).to be_instance_of(TripletexRubyClient::TravelExpensecostApi)
    end
  end
