...
# Unit tests for TripletexRubyClient::TravelExpenseaccommodationAllowanceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelExpenseaccommodationAllowanceApi' do
  before do
    # run before each test
    @instance = TripletexRubyClient::TravelExpenseaccommodationAllowanceApi.new
  end
  ...
  describe 'test an instance of TravelExpenseaccommodationAllowanceApi' do
    it 'should create an instance of TravelExpenseaccommodationAllowanceApi' do
      expect(@instance).to be_instance_of(TripletexRubyClient::TravelExpenseaccommodationAllowanceApi)
    end
  end
